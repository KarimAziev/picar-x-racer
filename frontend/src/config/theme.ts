...
export const baseColor = "#00ffbf";
export const customPrimaryPalette = palette(baseColor);
...
export const RoboPreset = definePreset(Aura, theme);

export const pt = {
  treeselect: {
    dropdownIcon: {
      class: "w-width-percent-40",
    },
  },
  select: {
    root: {
