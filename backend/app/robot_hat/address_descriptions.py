ADDRESS_DESCRIPTIONS = {
    0x44: "Register from 0x44 is to set the PWM period, Set timer 0 Period",
    0x45: "Register from 0x45 is to set the PWM period, Set timer 1 Period",
    0x46: "Register from 0x46 is to set the PWM period, Set timer 2 Period",
    0x47: "Register from 0x47 is to set the PWM period, Set timer 3 Period",
