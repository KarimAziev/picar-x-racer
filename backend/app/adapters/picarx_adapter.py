    ...
    def __init__(
        ...
        self.cam_pan_servo = ServoService(
            servo=Servo(
                ...
                min_pulse=self.config.cam_pan_servo.min_pulse,
                max_pulse=self.config.cam_pan_servo.max_pulse,
            ),
        ...
        self.cam_tilt_servo = ServoService(
            servo=Servo(
                ...
                min_pulse=self.config.cam_tilt_servo.min_pulse,
                max_pulse=self.config.cam_tilt_servo.max_pulse,
            ),
        ...
        self.steering_servo = ServoService(
            servo=Servo(
                ...
                min_pulse=self.config.steering_servo.min_pulse,
                max_pulse=self.config.steering_servo.max_pulse,
            ),
